...
{
  // التحكم اليدوي بالمحركات
  int leftSpeed = map(receiverData.yAxisValue, 0, 254, -MAX_MOTOR_SPEED, MAX_MOTOR_SPEED);
  int rightSpeed = map(receiverData.xAxisValue, 0, 254, -MAX_MOTOR_SPEED, MAX_MOTOR_SPEED);
