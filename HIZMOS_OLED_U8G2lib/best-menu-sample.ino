/*NEED TO BE CONVERTED WITH POINTER* */


void handlesamplemenu() {
  const char* menuItems[] = {"OPTION1", "OPTION2", "OPTION3", "OPTION4", "OPTION5"};
  ...
  if (millis() - lastInputTime > 150) {
    ...
    if (digitalRead(BTN_SELECT) == LOW) {
      switch (selectedItem) {
        ...
        case 2: /* showSavedTags(); */ break;
        case 3: /* emulateNFCTag(); */ break;
        case 4: /* startP2PMode(); */ break;
      }
